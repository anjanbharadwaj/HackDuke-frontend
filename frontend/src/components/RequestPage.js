...
import RestaurantDonationCard from './RestaurantDonationCard';
import RestaurantDonationModal from './RestaurantDonationModal';
...
function RequestPage(props) {
    ...
    if (usertype == "charity") {
        ...
        console.log("IN RESTAURANT CASE")
        return (
            <div class="grid grid-cols-3 gap-8">
                <div class="col-span-2">
                    <div class="grid grid-cols-3 gap-8">
                        <div class="col-span-2">
                            <p class="font-semibold text-4xl mb-8">My Donations</p>
                        </div>
                        <div class="col-span-1 ...">
                            <button onClick={() => setReqModal(!reqModal)} type="submit"
                                class="float-right inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-reg hover:bg-blue-reg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-reg">
                    ...
                    <RestaurantDonationCard />
                    {reqModal ? <RestaurantDonationModal toggleReqModal={() => setReqModal(!reqModal)} /> : <div></div>}
                </div>
                <div class="col-span-1 h-full mr-5">
                    <PastRequests />
                </div>
